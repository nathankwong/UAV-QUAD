...
def run_sim(sim: MsgSimParams, end_pose: NP_MAT, init_state: Optional[DynamicState] = None, \
        world_view: Optional[WorldViewer] = None, data_view: Optional[DataViewer] = None) \
