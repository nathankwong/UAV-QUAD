...
def run_sim(sim: MsgSimParams, init_state: DynamicState, fm: ForceMoments, mav_view: Optional[MavViewer] = None, \
    data_view: Optional[DataViewer] = None) -> tuple[MavViewer, DataViewer]:
