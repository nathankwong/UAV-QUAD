...
mass: float = 0.65 #kg
Jx: float = (7.5*10**-3) *2*np.pi #kg m^2
Jy: float = (7.5*10**-3)*2*np.pi
Jz: float = (1.3*10**-2)*2*np.pi
Jxz: float = 0.1204
rho: float = 1.2682 # air density
e: float = 0.9 # Oswald efficiency factor
gravity: float = 9.81
Length=0.232 #Length of center of mass to center for prop

#These are not needed due to us using a quadcopter 
# Jxz= float=0. 
