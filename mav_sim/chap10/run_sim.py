...
def run_sim(sim: MsgSimParams, path_fnc: PathFunction, init_state: Optional[DynamicState] = None, \
        path_view: Optional[PathViewer] = None, data_view: Optional[DataViewer] = None) \
