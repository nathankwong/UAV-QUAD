...
def run_sim(sim: MsgSimParams, waypoints: MsgWaypoints, init_state: Optional[DynamicState] = None, \
        waypoint_view: Optional[WaypointViewer] = None, data_view: Optional[DataViewer] = None) \
